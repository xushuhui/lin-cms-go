...
var (
	...
	LinGroupPermissionColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt, Increment: true},
		{Name: "group_id", Type: field.TypeInt, Unique: true},
	...
	LinGroupPermissionTable = &schema.Table{
		...
		PrimaryKey: []*schema.Column{LinGroupPermissionColumns[0]},
	}
	...
	// LinPermissionLinGroupColumns holds the columns for the "lin_permission_lin_group" table.
	LinPermissionLinGroupColumns = []*schema.Column{
		{Name: "lin_permission_id", Type: field.TypeInt},
		{Name: "lin_group_id", Type: field.TypeInt},
	}
	// LinPermissionLinGroupTable holds the schema information for the "lin_permission_lin_group" table.
	LinPermissionLinGroupTable = &schema.Table{
		Name:       "lin_permission_lin_group",
		Columns:    LinPermissionLinGroupColumns,
		PrimaryKey: []*schema.Column{LinPermissionLinGroupColumns[0], LinPermissionLinGroupColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "lin_permission_lin_group_lin_permission_id",
				Columns:    []*schema.Column{LinPermissionLinGroupColumns[0]},
				RefColumns: []*schema.Column{LinPermissionColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "lin_permission_lin_group_lin_group_id",
				Columns:    []*schema.Column{LinPermissionLinGroupColumns[1]},
				RefColumns: []*schema.Column{LinGroupColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
...
func init() {
	...
	LinGroupPermissionTable.Annotation = &entsql.Annotation{
	...
	LinPermissionLinGroupTable.ForeignKeys[0].RefTable = LinPermissionTable
	LinPermissionLinGroupTable.ForeignKeys[1].RefTable = LinGroupTable
}
